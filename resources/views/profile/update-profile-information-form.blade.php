            ...
            <div class="card-body pt-9 pb-0">
                ...
                <div class="d-flex overflow-auto h-55px">
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                        <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary me-6" href="{{route('profile.view')}}">Overview</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="name" id="name" autocomplete="off" required class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" placeholder="Name" value="{{$user->name}}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
