    ...
    <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100"  method="POST" action="{{ route('password.email') }}">@csrf
                ...
                <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                    <button type="submit" id="kt_sign_in_submit" class="btn btn-lg btn-primary button fw-bolder me-4">
                        <span class="indicator-label">{{ __('Send Password Reset Link') }}</span>
                        <span class="indicator-progress">Please wait...
                        <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                    </button>
                    <a href="/login" class="btn btn-lg btn-danger button-reverse fw-bolder">Cancel</a>
                </div>
                <!--end::Actions-->
            </form>
            <!--end::Form-->
